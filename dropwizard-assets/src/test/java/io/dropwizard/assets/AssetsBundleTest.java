...
public class AssetsBundleTest {
    ...
    @Test
    public void canSupportAdminEnvironment() {
    ...
    private void runBundle(AssetsBundle bundle, ServletEnvironment servletEnvironment) {
      runBundle(bundle, "assets", servletEnvironment);
    }

    private void runBundle(AssetsBundle bundle, String assetName) {
      runBundle(bundle, assetName, servletEnvironment);
    }

    private void runBundle(AssetsBundle bundle, String assetName, ServletEnvironment servletEnvironment) {
